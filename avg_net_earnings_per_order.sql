...
-- To find out the avg net earnings per order that grouped by weekday and hour from cust_placed_order_datetiem
...
select dayname as weekday, hour as order_hour, round(avg(net_earnings),2) as net_earn from cte
