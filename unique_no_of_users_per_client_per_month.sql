...
-- To fin out the unique no. of users per client per  monnth
...
VALUES
    ...
    (2, '2020-02-28', '7892-ΡΟΟΚΡ', 'Connectix', 'mobile', 'file received', 2), 
...
select count(distinct user_id) as unqiue_users, client_id, month(time_id) as per_month 
from fact_events group by  client_id,month(time_id)
order by per_month;