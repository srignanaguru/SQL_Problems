...
-- To find out the highest paid employees job titles
...
VALUES(1, 'Engineer', '2020-01-15'), (2, 'Marketing Manager', '2019-03-10'), 
(3, 'Sales Manager', '2021-06-21'), (4, 'Junior Engineer', '2018-04-30'), (5, 'Senior Salesperson','2021-01-15');
...
with cte as(
select t.worker_title, dense_rank() over (order by w.salary desc) as highest_paid_rank from worker w 
join title t on w.worker_id=t.worker_ref_id
)

select worker_title from cte where highest_paid_rank=1;